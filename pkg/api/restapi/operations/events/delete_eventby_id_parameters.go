...
// DeleteEventbyIDParams contains all the bound params for the delete eventby ID operation
...
//
// To ensure default values, the struct must have been initialized with NewDeleteEventbyIDParams() beforehand.
